...
Public Class crQtyCounterBYsize
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HeartyCafe.crQtyCounterBYsize.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrQtyCounterBYsize
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crQtyCounterBYsize = New crQtyCounterBYsize()
        rpt.Site = Me.Site
        Return rpt
    End Function
