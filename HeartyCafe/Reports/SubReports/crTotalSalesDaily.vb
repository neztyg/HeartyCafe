...
Public Class crTotalSalesDaily
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HeartyCafe.crTotalSalesDaily.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrTotalSalesDaily
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crTotalSalesDaily = New crTotalSalesDaily()
        rpt.Site = Me.Site
        Return rpt
    End Function
